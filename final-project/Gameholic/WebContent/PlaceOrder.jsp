...
<body>
	...
	<form action="placeorder" method="post" class="form-horizontal">
		<div class="form-group">
			<label for="title"><strong>Title</strong></label>
			<input id="title" name="title" value="${fn:escapeXml(param.title)}">
		</div>
		<div class="form-group">
			<label for="username"><strong>UserName</strong></label></h2>
			<input id="username" name="username" value="">
		</div>
		<div class="form-group">
			<label for="address"><strong>Address</strong></label></h2>
			<input id="address" name="address" value="">
		</div>
		<div class="form-group">
			<button type="submit" class="btn btn-md btn-primary">Place Order</button>
		</div>
	</form>
	<br/><br/>
	<p>
