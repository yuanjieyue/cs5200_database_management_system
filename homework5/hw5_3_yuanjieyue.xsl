...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/ReviewApplication">
        ...
        <!-- Map each CompanyName to an array of all its Restaurant Names -->
        <table border="1">
            <tr>
                <th>CompanyName</th>
                <th>Restaurants</th>
            ...
            <xsl:for-each select="Restaurants/Restaurant">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        -->
                        <xsl:value-of select="ReviewApplication/Restaurants/Restaurant[CompanyName/text()=$company]/Name"></xsl:value-of>
                    </td>
                    </td>
                </tr>
            </xsl:for-each>
