...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/ReviewApplication">
        ...
        <!-- Map each Restaurant Name to a count of their Recommendations. -->
        <table border="1">
            <tr>
                <th>Restaurants</th>
            ...
            <xsl:for-each select="Restaurants/Restaurant">
                ...
                select="count(/ReviewApplication/Recommendations/Recommendation/[RestaurantId/text()=$restaurantId])"></xsl:variable>
                <tr>
                    <td>
